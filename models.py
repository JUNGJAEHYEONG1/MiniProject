...
class MealKit(Base):
    ...
    user_id = Column(Integer, ForeignKey("DailyRecommendations.recommendation_id"), unique=True)
...
class Recipe(Base):
    ...
    recommendations = relationship("DailyRecommendation", back_populates="recipe")
